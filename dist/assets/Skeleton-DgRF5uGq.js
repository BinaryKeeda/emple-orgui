import{c as C,j as c,a as b,g as w,r as k,u as x,s as R,d as S,f as $,m as A,ac as u,ad as m}from"./index-BKh3Z22c.js";const N=C(c.jsx("path",{d:"m10 17 5-5-5-5z"}));function U(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function M(t){return parseFloat(t)}function j(t){return b("MuiSkeleton",t)}w("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return $({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},j,e)},r=m`
  0% {
    opacity: 1;
  }
