  ...
  const handleDownloadExcel = async () => {
    ...
    try {
      const response = await axios.get(
        `${BASE_URL}/api/campus/quiz/sections/download/${slug}/${id}`,
        {
          responseType: "blob",
          withCredentials: true,
        }
      ...
      a.href = url;
      a.download = `quiz_submissions_${slug}.xlsx`;
  ...
  return (
    <div className="p-6 flex flex-col gap-8">
      ...
      <div className="flex justify-between items-center">
        <h2 className="text-lg font-semibold">Quiz Submissions</h2>
        ...
        <Button
          ...
          startIcon={
            downloading ? <CircularProgress size={18} color="inherit" /> : <CloudDownload />
          }
        >
